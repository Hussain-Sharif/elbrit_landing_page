...
export const Hero=()=>(
    ...
    <ReUseDiv aS="center" top="-50px" fW="wrap" display="flex" fD="column" jC="center" aI="center" fDB="row"  p="15px" border="none" position="relative" br="25px" w="80%" bg="#17414F" >
        ...
        <ReUseDiv border="none" m="10px" mbB="0" position="relative" w="100%" wB="30%" left="0px" topB="-60px" display="flex" fD="row" fDB="column" jC="flex-start" aI="center">
                <ReUseDiv>
