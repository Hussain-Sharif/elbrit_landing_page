...
export const Footer=()=>(
    <ReUseDiv w="100%" bg="#17414F" p="15px" display="flex" fD="column" jC="center" aI="center">
        <ReUseDiv w="80%" display="flex" fD="column" jC="flex-start" aI="center">
            <ReUseDiv order="1" orderB="0" mb="40px"  w="100%" display="flex" fD="column" fDB="row" jC="center" jCB="space-between" aI="center">
